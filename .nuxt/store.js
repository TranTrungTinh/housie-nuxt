...
void (function updateModules() {
  ...
  resolveStoreModules(require('@/store/modules/task.js'), 'modules/task.js')
  resolveStoreModules(require('@/store/modules/user.js'), 'modules/user.js')
  resolveStoreModules(require('@/store/modules/utilities.js'), 'modules/utilities.js')
